...
if(("" == trim($_POST['Name'])) || ("" == trim($_POST['email'])) || ("" == trim($_POST['sex'])) || ("" == trim($_POST['age'])) || ("" == trim($_POST['height'])) || ("" == trim($_POST['weight'])) || ("" == trim($_POST['body_fat']))){
    echo "Register Not Success";
}


else if(isset($_POST['Name']) && isset($_POST['email']) && isset($_POST['sex']) && isset($_POST['age']) && isset($_POST['height']) && isset($_POST['weight']) && isset($_POST['body_fat']) && isset($_POST['date'])){
    $N = $_POST['Name'];
    $e = $_POST['email'];
    $checksql = "Select Name from basic_information where (Name='$N') and (email='$e')";
    ...
    if(!empty($issign)){
        ...
        $sql = "INSERT INTO basic_information (Name, email, sex, age, height, weight, body_fat, BMI, fit_intensity, eat_intensity, BMR, date) values (:Name, :email, :sex, :age, :height, :weight, :body_fat, :BMI, :fit_intensity, :eat_intensity, :BMR, :date)";//PDO寫法
