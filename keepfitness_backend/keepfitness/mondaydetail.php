...
if(isset($_POST['Name']) && isset($_POST['email'])){
    $Name=$_POST['Name'];
    $email=$_POST['email'];
    $mon_ins_sql = "select item, bodypart, comment from ((fit_menu natural join fit_detail) natural join fit_comment) natural join basic_information where (Name = '$Name') and (email = '$email') and day = 1";
