...
public class description5 extends AppCompatActivity {
    ...
    public static int[] item={R.id.item11,R.id.item22,R.id.item33,R.id.item44,R.id.item55,R.id.item66,R.id.item77};
    public static int[] body={R.id.bodypart1,R.id.bodypart2,R.id.bodypart3,R.id.bodypart4,R.id.bodypart5,R.id.bodypart6,R.id.bodypart7};
    public static int[] comment={R.id.comment1,R.id.comment2,R.id.comment3,R.id.comment4,R.id.comment5,R.id.comment6,R.id.comment7};
    public JSONArray JA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //返回到健身菜單畫面
                Intent intent = new Intent(description5.this, day5.class);
        ...
        executorService.execute(new Runnable() {
            ...
            @Override
            public void run() {
                String fri_dt_url = "http://"+addurl+"/keepfitness/fridaydetail.php";
                try {
                    URL url = new URL(fri_dt_url);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        for(int i=0;i< JA.length();i++){
                            TextView tvitem = findViewById(item[i]);
                            TextView tvbody = findViewById(body[i]);
                            TextView tvcom = findViewById(comment[i]);
