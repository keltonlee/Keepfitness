...
public class description2 extends AppCompatActivity {
    ...
    public static int[] item={R.id.item11,R.id.item22,R.id.item33,R.id.item44,R.id.item55};
    public static int[] body={R.id.bodypart1,R.id.bodypart2,R.id.bodypart3,R.id.bodypart4,R.id.bodypart5};
    public static int[] comment={R.id.comment1,R.id.comment2,R.id.comment3,R.id.comment4,R.id.comment5};
    public JSONArray JA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //返回到健身菜單畫面
        Intent intent = new Intent(description2.this, day2.class);
        ...
        executorService.execute(new Runnable() {
            ...
            @Override
            public void run() {
                String tue_dt_url = "http://"+addurl+"/keepfitness/tuesdaydetail.php";
                try {
                    URL url = new URL(tue_dt_url);
